...
class Logger:
    def log(self, message):
        ...
        logging.info('[TimeTracking] {function_name} - total: {total_time:3.6f} s - partial: {partial_time:3.6f} s'.format(**message))


class TimeTracker:

    logger = Logger()
    def __init__(self, logger=logger, do_time_tracking=True, isolated=True):
        self._logger = logger
